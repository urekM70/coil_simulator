/****************************************************************************
** Meta object code from reading C++ file 'simulation_controller.h'
**
...
#error "The header file 'simulation_controller.h' doesn't include <QObject>."
...
template <> constexpr inline auto SimulationController::qt_create_metaobjectdata<qt_meta_tag_ZN20SimulationControllerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'setSimulationMode'
        QtMocHelpers::SlotData<void(enum SimulationMode)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void SimulationController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setSimulationMode((*reinterpret_cast<std::add_pointer_t<enum SimulationMode>>(_a[1]))); break;
        default: ;
        }
    }
}
