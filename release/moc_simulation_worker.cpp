...
template <> constexpr inline auto SimulationWorker::qt_create_metaobjectdata<qt_meta_tag_ZN16SimulationWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'fieldLinesCalculated'
        QtMocHelpers::SignalData<void(const std::vector<FieldLine> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'calculateMagneticField'
        QtMocHelpers::SlotData<void(const std::vector<Vec3> &, float)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 }, { QMetaType::Float, 8 },
        }}),
    };
...
void SimulationWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->fieldLinesCalculated((*reinterpret_cast<std::add_pointer_t<std::vector<FieldLine>>>(_a[1]))); break;
        case 1: _t->calculateMagneticField((*reinterpret_cast<std::add_pointer_t<std::vector<Vec3>>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<float>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SimulationWorker::*)(const std::vector<FieldLine> & )>(_a, &SimulationWorker::fieldLinesCalculated, 0))
            return;
    }
}
...
// SIGNAL 0
void SimulationWorker::fieldLinesCalculated(const std::vector<FieldLine> & _t1)
{
